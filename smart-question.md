...
4.  попытайтесь найти ответ в списке часто задаваемых вопросов (ЧаВО, FAQ — Frequently Asked Questions)
...
**Правильно:**  Код проекта foo не компилируетя в ОС Nulix версии 6.2. Я прочитал ЧаВО, но там нет ничего о проблемах с Nulix. Вот запись сеанса компиляции. Что я сделал неправильно?
...
_На первую ошибку укажите в частном порядке._  Нет необходимости публично унижать человека, который возможно, честно ошибается. Начинающий пользователь может не знать, как искать в архивах или где находится или публикуется список ЧаВО.
